        		...
        		<div class="row">
			    	<ul id="nav2" class="nav2 clearfix">
						...
						<li class="nLi on">
						 ...
						 <% 	for(int i=1;i<top_daohang.size();i++){%>
						<li class="nLi">
							...
							<div class="tab-inner cell-list">
								<div class="cell">
									...
									<div class="cell_primary">
										<a href="news-inner.html" target="_blank"><h3 class="color-dd2727 mb15">习近平致信祝贺“中国天眼”落成启用</h3></a>	
										<p class="mb20">
												<a href="news-inner.html" class="line3 color-666666">国家重大科技基础设施500米口径球面射电望远镜今天落成启用。习近平指出，500米口径球面射电望远镜是具有我国自主知识产权、世界重大单口径、最灵敏的射电望远镜。
								...
								<div class="cell">
									...
									<div class="cell_primary">
										<a href="" target="_blank"><h3 class="color-dd2727 mb15">习近平致信祝贺“中国天眼”落成启用</h3></a>	
										<p class="mb20">
												<a href="" class="line3 color-666666">国家重大科技基础设施500米口径球面射电望远镜今天落成启用。习近平指出，500米口径球面射电望远镜是具有我国自主知识产权、世界重大单口径、最灵敏的射电望远镜。
													它的落成启用，对我国在科学前沿实现重大原创突破、加快创新驱动发展具有重要意义。国家重大科技基础设施500米口径球面射电望……</a>
										</p>
										<p class="color-666666">来自：新华社<span>|</span>2016-9-27<span class="glyphicon glyphicon-eye-open color-ff6600"></span>1377</p>
										<div class="bdsharebuttonbox bd-share">
