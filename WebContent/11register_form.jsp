...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="../css/ce-login.css" rel="stylesheet" type="text/css" />
		<link href="../css/ce-page_bottom.css" rel="stylesheet" type="text/css" />
		<script src="../js/ce-jquery-1.4.3.js"></script>
		<script src="../js/ce-checkUserRegist.js"></script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="register" id="regist_form">
				...
				<a href="Mailto:18244686060@163.com">给我发邮件</a>    
